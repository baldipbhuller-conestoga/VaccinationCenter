...
namespace VaccinationCenter
{
    public class Controller
    {
        ...
        public int RegisterAccount(string accountType, string username, string password, string fName, string mName, string lName, DateTime dt, string city, string postalCode)
        {
            LoadAccounts();

            Account checkAcc = AccountList.Find(a => a.Username == username);
